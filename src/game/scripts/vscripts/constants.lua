...
Constants.FAT_SCALING = {
	...
	npc_dota_hero_axe = 2.8,
	npc_dota_hero_bane = 2.4,
	npc_dota_hero_beastmaster = 2.8,
	npc_dota_hero_bloodseeker = 3.6,
	npc_dota_hero_chen = 3.2,
	...
	npc_dota_hero_enigma = 2.8,
	npc_dota_hero_faceless_void = 3.6,
	npc_dota_hero_furion = 3.2,
	npc_dota_hero_juggernaut = 3.6,
	npc_dota_hero_kunkka = 3.2,
	npc_dota_hero_leshrac = 3.2,
	npc_dota_hero_lich = 2.4,
	npc_dota_hero_life_stealer = 2.8,
	npc_dota_hero_lina = 3.2, --Flying, but small model
	npc_dota_hero_lion = 3.2,
	npc_dota_hero_mirana = 2.8,
	npc_dota_hero_morphling = 3.2,
	npc_dota_hero_necrolyte = 3.2,
	npc_dota_hero_nevermore = 2.8,
	npc_dota_hero_night_stalker = 2.8,
	npc_dota_hero_omniknight = 3.2,
	npc_dota_hero_puck = 3.2, --Flying, but small model
	npc_dota_hero_pudge = 2.8,
	...
	npc_dota_hero_shadow_shaman = 3.2,
	...
	npc_dota_hero_lone_druid = 3.2,
	npc_dota_hero_brewmaster = 2.8,
	npc_dota_hero_phantom_lancer = 2.8,
	npc_dota_hero_treant = 2.8,
	npc_dota_hero_ogre_magi = 2.8,
	npc_dota_hero_chaos_knight = 2.8,
	npc_dota_hero_phantom_assassin = 3.2,
	npc_dota_hero_gyrocopter = 2.4,
	npc_dota_hero_rubick = 2.8,
	npc_dota_hero_luna = 2.8,
	npc_dota_hero_wisp = 2.8, --Io doesn't scale well visually, so we can be more modest. His particles just rise up in the air while his clickbox grows.
	npc_dota_hero_disruptor = 2.8,
	npc_dota_hero_undying = 2.4,
	npc_dota_hero_templar_assassin = 2.8,
	npc_dota_hero_naga_siren = 3.2,
	npc_dota_hero_nyx_assassin = 3.2,
