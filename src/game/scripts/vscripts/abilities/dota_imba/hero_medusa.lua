...
LinkLuaModifier("modifier_imba_medusa_mystic_snake_tracker", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_medusa_mana_shield_meditate", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_medusa_mana_shield", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_medusa_stone_gaze", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_medusa_stone_gaze_facing", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_medusa_stone_gaze_stone", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_medusa_stone_gaze_red_eyes", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_medusa_stone_gaze_red_eyes_facing", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_medusa_stone_gaze_stiff_joints", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_medusa_serpent_shot:DeclareFunctions()
	local decFuncs = {
		...
		-- elfansoer: fix serpent shot not having projectile (due to missing particles)
...
function imba_medusa_mystic_snake:OnProjectileHit_ExtraData(hTarget, vLocation, ExtraData)
	...
	if hTarget:IsAlive() and not hTarget:IsInvulnerable() and not hTarget:IsOutOfGame() then
		...
		if not hTarget:TriggerSpellAbsorb(self) then
			...
			-- elfansoer: fix blocked/reflected weird behavior
			return
		end
	end
...
LinkLuaModifier("modifier_special_bonus_imba_medusa_bonus_mana", "abilities/dota_imba/hero_medusa", LUA_MODIFIER_MOTION_NONE)
