...
LinkLuaModifier("modifier_imba_keeper_of_the_light_spirit_form_illuminate", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_keeper_of_the_light_blinding_light", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_blinding_light_knockback", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_imba_keeper_of_the_light_chakra_magic", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_keeper_of_the_light_mana_leak", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_keeper_of_the_light_spotlights", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_keeper_of_the_light_will_o_wisp", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_keeper_of_the_light_will_o_wisp_aura", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_imba_keeper_of_the_light_will_o_wisp_blessing", "abilities/dota_imba/hero_keeper_of_the_light.lua", LUA_MODIFIER_MOTION_NONE)
...
function imba_keeper_of_the_light_illuminate:OnUpgrade()
	...
	if illuminate_end then
		...
		-- elfansoer: automatically add illuminate end when upgrading
		illuminate_end = self:GetCaster():AddAbility( "imba_keeper_of_the_light_illuminate_end" )
		illuminate_end:SetLevel(self:GetLevel())
	end
end
...
function imba_keeper_of_the_light_chakra_magic:OnSpellStart()
	...
	-- Enemy logic
		...
		-- Emit cast sound
		-- elfansoer: fix mana leak not produce sounds
		...
		self.caster:EmitSound("Hero_KeeperOfTheLight.ManaLeak.Cast")
		self.target:EmitSound("Hero_KeeperOfTheLight.ManaLeak.Target")
		self.target:EmitSound("Hero_KeeperOfTheLight.ManaLeak.Target.FP")
...
function modifier_imba_keeper_of_the_light_mana_leak:OnDestroy()
	...
	self.parent:StopSound("Hero_KeeperOfTheLight.ManaLeak.Target.FP")
end
...
LinkLuaModifier("modifier_special_bonus_imba_keeper_of_the_light_luminous_burster", "abilities/dota_imba/hero_keeper_of_the_light", LUA_MODIFIER_MOTION_NONE)
