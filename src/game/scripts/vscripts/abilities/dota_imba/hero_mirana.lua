...
LinkLuaModifier("modifier_imba_starfall_scepter_thinker", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_starfall_talent_seed_debuff", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_starfall_scepter_thinker:OnIntervalThink()
	if IsServer() then
		...
		-- elfansoer: fix missing method reference
...
LinkLuaModifier("modifier_imba_sacred_arrow_stun", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_sacred_arrow_haste", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_mirana_leap", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_leap_movement", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_leap_aura", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_leap_speed_boost", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_leap_talent_cast_angle_handler", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_moonlight_shadow", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_moonlight_shadow_invis", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_moonlight_shadow_invis_dummy", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_moonlight_shadow_invis_fade_time", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_moonlight_shadow_talent_starstorm", "abilities/dota_imba/hero_mirana", LUA_MODIFIER_MOTION_NONE)
