...
LinkLuaModifier("modifier_imba_bristleback_quill_spray", "abilities/dota_imba/hero_bristleback.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_bristleback_quill_spray_stack", "abilities/dota_imba/hero_bristleback.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_bristleback_quill_spray_autocaster", "abilities/dota_imba/hero_bristleback.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_bristleback_bristleback", "abilities/dota_imba/hero_bristleback.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_bristleback_bristleback_has", "abilities/dota_imba/hero_bristleback.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_bristleback_warpath", "abilities/dota_imba/hero_bristleback.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_bristleback_warpath_stack", "abilities/dota_imba/hero_bristleback.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_bristleback_warpath_revenge", "abilities/dota_imba/hero_bristleback.lua", LUA_MODIFIER_MOTION_NONE)
...
-- LinkLuaModifier("modifier_special_bonus_imba_bristleback_1", "abilities/dota_imba/hero_bristleback", LUA_MODIFIER_MOTION_NONE)
-- LinkLuaModifier("modifier_special_bonus_imba_bristleback_2", "abilities/dota_imba/hero_bristleback", LUA_MODIFIER_MOTION_NONE)
 LinkLuaModifier("modifier_special_bonus_imba_bristleback_3", "abilities/dota_imba/hero_bristleback", LUA_MODIFIER_MOTION_NONE)
-- LinkLuaModifier("modifier_special_bonus_imba_bristleback_4", "abilities/dota_imba/hero_bristleback", LUA_MODIFIER_MOTION_NONE)
-- LinkLuaModifier("modifier_special_bonus_imba_bristleback_5", "abilities/dota_imba/hero_bristleback", LUA_MODIFIER_MOTION_NONE)
-- LinkLuaModifier("modifier_special_bonus_imba_bristleback_6", "abilities/dota_imba/hero_bristleback", LUA_MODIFIER_MOTION_NONE)
-- LinkLuaModifier("modifier_special_bonus_imba_bristleback_7", "abilities/dota_imba/hero_bristleback", LUA_MODIFIER_MOTION_NONE)
-- LinkLuaModifier("modifier_special_bonus_imba_bristleback_8", "abilities/dota_imba/hero_bristleback", LUA_MODIFIER_MOTION_NONE)
