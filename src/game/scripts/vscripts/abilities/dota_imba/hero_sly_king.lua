...
LinkLuaModifier( "modifier_imba_frost_gale_setin", "abilities/dota_imba/hero_sly_king.lua", LUA_MODIFIER_MOTION_NONE )		-- Set in modifier (slow)
LinkLuaModifier( "modifier_imba_frost_gale_debuff", "abilities/dota_imba/hero_sly_king.lua", LUA_MODIFIER_MOTION_NONE )		-- Root
...
LinkLuaModifier("modifier_imba_burrowblast_burrow", "abilities/dota_imba/hero_sly_king.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_frozen_skin_passive", "abilities/dota_imba/hero_sly_king", LUA_MODIFIER_MOTION_NONE) --intrinsic modifier
LinkLuaModifier("modifier_imba_frozen_skin_debuff", "abilities/dota_imba/hero_sly_king", LUA_MODIFIER_MOTION_NONE)  --frostbite debuff
...
LinkLuaModifier("modifier_imba_winterbringer_pulse", "abilities/dota_imba/hero_sly_king.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_winterbringer_slow", "abilities/dota_imba/hero_sly_king.lua", LUA_MODIFIER_MOTION_NONE)
