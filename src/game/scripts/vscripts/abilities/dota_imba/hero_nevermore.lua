...
LinkLuaModifier("modifier_imba_dark_lord_aura", "abilities/dota_imba/hero_nevermore.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_reqiuem_phase_buff", "abilities/dota_imba/hero_nevermore.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_reqiuem_debuff", "abilities/dota_imba/hero_nevermore.lua", LUA_MODIFIER_MOTION_NONE)
