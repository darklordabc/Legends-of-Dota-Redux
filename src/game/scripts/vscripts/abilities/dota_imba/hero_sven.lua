...
--            STORM BOLT
-------------------------------------------
LinkLuaModifier("modifier_imba_storm_bolt_caster", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_storm_bolt_crit", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
...
-- 				GREAT CLEAVE
-------------------------------------------
LinkLuaModifier("modifier_imba_great_cleave", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_great_cleave_active", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
...
--            WARCRY
-------------------------------------------
LinkLuaModifier("modifier_imba_warcry", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_warcry_immunity", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
...
--			GOD'S STRENGTH
-------------------------------------------
LinkLuaModifier("modifier_imba_god_strength", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_god_strength_allies", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
...
--			COLOSSAL SLASH
-------------------------------------------
LinkLuaModifier("modifier_imba_colossal_slash_animation", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_colossal_slash_crit", "abilities/dota_imba/hero_sven", LUA_MODIFIER_MOTION_NONE)
