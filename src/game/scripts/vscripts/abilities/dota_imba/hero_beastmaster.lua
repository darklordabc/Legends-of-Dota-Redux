...
LinkLuaModifier("modifier_imba_beastmaster_hawk",  "abilities/dota_imba/hero_beastmaster", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_hawk_invis_handler",  "abilities/dota_imba/hero_beastmaster", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_hawk_invis",  "abilities/dota_imba/hero_beastmaster", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_beastmaster_boar",  "abilities/dota_imba/hero_beastmaster", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_boar_poison" , "abilities/dota_imba/hero_beastmaster", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_boar_poison_debuff" , "abilities/dota_imba/hero_beastmaster", LUA_MODIFIER_MOTION_NONE)
