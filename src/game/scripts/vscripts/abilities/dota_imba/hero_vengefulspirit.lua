...
--				 RANCOR
-------------------------------------------
LinkLuaModifier("modifier_imba_rancor", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_rancor_stack", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_rancor_allies", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
...
-------------------------------------------
LinkLuaModifier("modifier_imba_wave_of_terror", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
...
--            VENGEANCE AURA
-------------------------------------------
LinkLuaModifier("modifier_imba_command_aura_positive", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_command_aura_positive_aura", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_command_aura_negative", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_command_aura_negative_aura", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_nether_swap", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
...
--            SWAPBACK
-------------------------------------------
LinkLuaModifier("modifier_imba_swap_back", "abilities/dota_imba/hero_vengefulspirit", LUA_MODIFIER_MOTION_NONE)
