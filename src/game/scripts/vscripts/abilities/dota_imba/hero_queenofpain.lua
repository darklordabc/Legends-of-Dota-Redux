...
--			DELIGHTFUL TORMENT
-------------------------------------------
LinkLuaModifier("modifier_imba_delightful_torment_thinker", "abilities/dota_imba/hero_queenofpain", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_delightful_torment_as_bonus", "abilities/dota_imba/hero_queenofpain", LUA_MODIFIER_MOTION_NONE)
...
--			  SHADOW STRIKE
-------------------------------------------
LinkLuaModifier("modifier_imba_shadow_strike_debuff", "abilities/dota_imba/hero_queenofpain", LUA_MODIFIER_MOTION_NONE)
...
--				BLINK
-------------------------------------------
LinkLuaModifier("modifier_imba_queenofpain_blink_decision_time", "abilities/dota_imba/hero_queenofpain", LUA_MODIFIER_MOTION_NONE)
...
--			SCREAM OF PAIN
-------------------------------------------
LinkLuaModifier("modifier_imba_scream_of_pain_reflect", "abilities/dota_imba/hero_queenofpain", LUA_MODIFIER_MOTION_NONE)
...
--            SONIC WAVE
-------------------------------------------
LinkLuaModifier("modifier_imba_sonic_wave", "abilities/dota_imba/hero_queenofpain", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_sonic_wave_daze", "abilities/dota_imba/hero_queenofpain", LUA_MODIFIER_MOTION_NONE)
