...
LinkLuaModifier("modifier_imba_sadist", "abilities/dota_imba/hero_necrolyte", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_sadist_stack", "abilities/dota_imba/hero_necrolyte", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_heartstopper_aura", "abilities/dota_imba/hero_necrolyte", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_heartstopper_aura_damage", "abilities/dota_imba/hero_necrolyte", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_reapers_scythe", "abilities/dota_imba/hero_necrolyte", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_reapers_scythe_debuff", "abilities/dota_imba/hero_necrolyte", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_reapers_scythe_respawn", "abilities/dota_imba/hero_necrolyte", LUA_MODIFIER_MOTION_NONE)
