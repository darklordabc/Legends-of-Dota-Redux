...
LinkLuaModifier("modifier_imba_breathe_fire_debuff", "abilities/dota_imba/hero_dragon_knight", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_dragon_tail", "abilities/dota_imba/hero_dragon_knight.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_dragon_tail_miss", "abilities/dota_imba/hero_dragon_knight.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_dragon_tail_debuff", "abilities/dota_imba/hero_dragon_knight.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_dragon_blood", "abilities/dota_imba/hero_dragon_knight.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier( "modifier_imba_elder_dragon_charge", "abilities/dota_imba/hero_dragon_knight.lua", LUA_MODIFIER_MOTION_NONE )
...
function imba_dragon_knight_elder_dragon_charge:OnProjectileHit(target, location)
	...
	if IsServer() then
		...
		if breathe_fire then
			health_as_damage = self:GetCaster():GetHealth() / 100 * breathe_fire:GetSpecialValueFor("health_as_damage")
			if self:GetCaster():HasTalent("special_bonus_imba_dragon_knight_1") then
...
LinkLuaModifier( "modifier_imba_elder_dragon_form", "abilities/dota_imba/hero_dragon_knight.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_imba_elder_dragon_form_debuff", "abilities/dota_imba/hero_dragon_knight.lua", LUA_MODIFIER_MOTION_NONE )
