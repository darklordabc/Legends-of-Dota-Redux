...
LinkLuaModifier("modifier_ghost_revenant_wraith", "abilities/dota_imba/hero_ghost_revenant.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier( "modifier_ghost_revenant_blackjack_debuff", "abilities/dota_imba/hero_ghost_revenant.lua", LUA_MODIFIER_MOTION_NONE )	-- Armor/vision debuff
...
--	Miasma
-----------------------------------------------------------------------------------------------------------
LinkLuaModifier( "modifier_ghost_revenant_miasma", "abilities/dota_imba/hero_ghost_revenant.lua", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier("modifier_ghost_revenant_ghost_immolation", "abilities/dota_imba/hero_ghost_revenant", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ghost_revenant_ghost_immolation_debuff", "abilities/dota_imba/hero_ghost_revenant", LUA_MODIFIER_MOTION_NONE)
...
--	Exhaustion
-----------------------------------------------------------------------------------------------------------
LinkLuaModifier( "modifier_ghost_revenant_exhaustion", "abilities/dota_imba/hero_ghost_revenant.lua", LUA_MODIFIER_MOTION_NONE )
