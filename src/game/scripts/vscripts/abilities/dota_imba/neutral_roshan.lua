...
LinkLuaModifier("modifier_imba_roshan_ai_diretide", "abilities/dota_imba/neutral_roshan", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_roshan_death_buff", "abilities/dota_imba/neutral_roshan", LUA_MODIFIER_MOTION_NONE)
