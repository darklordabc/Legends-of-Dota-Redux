...
--			TRANSPOSITION
-------------------------------------------
LinkLuaModifier("modifier_imba_telekinesis", "abilities/dota_imba/hero_rubick", LUA_MODIFIER_MOTION_BOTH)
LinkLuaModifier("modifier_imba_telekinesis_stun", "abilities/dota_imba/hero_rubick", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_telekinesis_root", "abilities/dota_imba/hero_rubick", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_telekinesis_caster", "abilities/dota_imba/hero_rubick", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_rubick_spell_steal_controller", "abilities/dota_imba/hero_rubick", LUA_MODIFIER_MOTION_NONE)
