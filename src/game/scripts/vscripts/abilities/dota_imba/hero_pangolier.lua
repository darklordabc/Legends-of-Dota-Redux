...
LinkLuaModifier("modifier_imba_swashbuckle_dash", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_swashbuckle_slashes", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_swashbuckle_buff", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_shield_crash_buff", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) -- Damage reduction
LinkLuaModifier("modifier_imba_shield_crash_jump", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) -- movement
LinkLuaModifier("modifier_imba_shield_crash_block", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) -- Talent #3: parry stacks
LinkLuaModifier("modifier_imba_shield_crash_block_parry", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) --Talent #3: Pangolier parry (100% evasion)
LinkLuaModifier("modifier_imba_shield_crash_block_miss", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) --Talent #3: Parried attack debuff (remove true strike during the attack)
...
LinkLuaModifier("modifier_imba_heartpiercer_passive", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_heartpiercer_delay", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_heartpiercer_debuff", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_heartpiercer_talent_debuff", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) --visual
LinkLuaModifier("modifier_imba_heartpiercer_talent_debuff_2", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) --visual
...
--LinkLuaModifier("modifier_imba_gyroshell_roll", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) 				------|
--LinkLuaModifier("modifier_imba_gyroshell_ricochet", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)			------|  IMBA MODIFIERS (not used atm)
--LinkLuaModifier("modifier_imba_gyroshell_stun", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)				------|
--LinkLuaModifier("modifier_imba_pangolier_gyroshell_bounce", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE)	------|
LinkLuaModifier("modifier_imba_gyroshell_impact_check", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) -- extend Rolling Thunder on each impact and implement #7 Talent
LinkLuaModifier("modifier_imba_gyroshell_linger", "abilities/dota_imba/hero_pangolier.lua", LUA_MODIFIER_MOTION_NONE) --Talent #4: Extra spell immunity
