...
LinkLuaModifier("modifier_imba_proximity_mine_charges", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_proximity_mine", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_proximity_mine_building_res", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_proximity_mine_talent", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_statis_trap", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_statis_trap_root", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_statis_trap_electrocharge", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_statis_trap_disarmed", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_blast_off", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_blast_off_movement", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_blast_off_silence", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_remote_mine", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_remote_mine_inflammable", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_focused_detonate", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_minefield_sign_aura", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_minefield_sign_detection", "abilities/dota_imba/hero_techies.lua", LUA_MODIFIER_MOTION_NONE)
