...
LinkLuaModifier("modifier_imba_earth_spirit_remnant_handler", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)	-- Remnant Handler + Earths Mark on attack
LinkLuaModifier("modifier_imba_stone_remnant", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)					-- Remnant Modifier
LinkLuaModifier("modifier_imba_earths_mark", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)					-- Earths Mark
LinkLuaModifier("modifier_imba_earth_spirit_layout_fix", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)		-- 6 slot layout fix

LinkLuaModifier("modifier_imba_earth_spirit_stone_caller_charge_counter", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE) -- Visible counter for how many free remnants there are

-- Elfansoer: Set stone remnant as leveled during spawn
function imba_earth_spirit_stone_remnant:OnHeroCalculateStatBonus()
...
function imba_earth_spirit_stone_remnant:OnSpellStart()
	if IsServer() then
		...
		-- Elfansoer: Stone remnant using default unit instead of imba version
		local dummy = CreateUnitByName("npc_dota_earth_spirit_stone", target, false, caster, nil, caster:GetTeamNumber())
...
function imba_earth_spirit_stone_remnant:CheckScepter()
	...
	-- Elfansoer: Set Petrify as normal ability
...
function modifier_imba_stone_remnant:OnCreated()
	if IsServer() then
		-- Elfansoer: Stone remnant using default unit instead of imba version
		if self:GetParent():GetUnitName() == "npc_dota_earth_spirit_stone" then
...
LinkLuaModifier("modifier_imba_boulder_smash_push", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)			-- Movement modifier
LinkLuaModifier("modifier_imba_boulder_smash_cast_thinker", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)	-- Used when the target is outside of unit cast range 
...
LinkLuaModifier("modifier_imba_rolling_boulder", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)		-- Movement handler
LinkLuaModifier("modifier_imba_rolling_boulder_slow", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)	-- Slow debuff
LinkLuaModifier("modifier_imba_rolling_boulder_disarm", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)		-- Disarm from earths mark
...
LinkLuaModifier("modifier_imba_geomagnetic_grip_pull", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)		-- Movement modifier
LinkLuaModifier("modifier_imba_geomagnetic_grip_silence", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)	-- Silence
LinkLuaModifier("modifier_imba_geomagnetic_grip_root", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)		-- Root
...
LinkLuaModifier("modifier_imba_magnetize", "abilities/dota_imba/hero_earth_spirit.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_special_bonus_imba_earth_spirit_4", "abilities/dota_imba/hero_earth_spirit", LUA_MODIFIER_MOTION_NONE)
