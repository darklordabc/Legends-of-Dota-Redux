...
LinkLuaModifier( "modifier_imba_dazzle_poison_touch_setin", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )		-- Set in modifier (slow + attack counter)
LinkLuaModifier( "modifier_imba_dazzle_poison_touch_debuff", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )		-- Stun + damage over time
LinkLuaModifier( "modifier_imba_dazzle_poison_touch_talent_slow", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )-- Because FUCK Valve, and FUCK net tables
...
LinkLuaModifier( "modifier_imba_dazzle_shallow_grave", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )				-- Shallow Grave effect
...
LinkLuaModifier( "modifier_imba_dazzle_shadow_wave_delayed_bounce", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )			-- Talent delayed wave bounce
LinkLuaModifier( "modifier_imba_dazzle_shadow_wave_delayed_bounce_cooldown", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )	-- Talent delayed wave bounce cooldown
...
LinkLuaModifier( "modifier_imba_dazzle_weave_buff", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )			-- Allied bonus armor
LinkLuaModifier( "modifier_imba_dazzle_weave_debuff", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )		-- Allied bonus armor
LinkLuaModifier( "modifier_imba_dazzle_ressurection_layout", "abilities/dota_imba/hero_dazzle.lua", LUA_MODIFIER_MOTION_NONE )	-- Ressurection ability layout modifier
...
----------------------
for i = 1,8 do
	LinkLuaModifier("modifier_special_bonus_imba_dazzle_"..i, "abilities/dota_imba/hero_dazzle", LUA_MODIFIER_MOTION_NONE)
end
