...
LinkLuaModifier("modifier_imba_strafe_aspd", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_strafe_mount", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_strafe_self_root", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_searing_arrows_passive", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_searing_arrows_active", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_searing_arrows_passive:OnCreated()
	-- Elfansoer: Fix general intrinsic problem:
...
function modifier_imba_searing_arrows_passive:OnAttackStart(keys)
	if IsServer() then
		...
		-- Elfansoer: Fix modifier not removed on lotus end
		...
		if not target:GetClassname()=="dota_item_drop" and not target:IsHero() and not target:IsBuilding() and not target:IsCreep() then
...
-- Elfansoer: Fix projectile using default Clinkz projectiles (uses modifier property instead of SetArrowAttackProjectile below)
function modifier_imba_searing_arrows_passive:GetModifierProjectileName()
...
LinkLuaModifier("modifier_imba_skeleton_walk_invis", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skeleton_walk_spook", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skeleton_walk_talent_root", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skeleton_walk_talent_ms", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_death_pact_buff", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_stack_creep", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_stack_hero", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_talent_debuff", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_talent_buff", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_hero_debuff", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_spirit_aura", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_spirit_attack_range", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_bonus_spirited", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_death_pact_spirit_aura_invis", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_special_bonus_imba_clinkz_5", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
-- #5 Talent: Frost Armor adds a portion of the Lich's intelligence to the armor bonus
LinkLuaModifier("modifier_imba_burning_army", "abilities/dota_imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
