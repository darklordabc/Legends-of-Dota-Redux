...
LinkLuaModifier("modifier_imba_nether_blast_magic_res", "abilities/dota_imba/hero_pugna.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_decrepify", "abilities/dota_imba/hero_pugna.lua", LUA_MODIFIER_MOTION_NONE)
...
-- Elfansoer: add Decrepify status effect
function modifier_imba_decrepify:GetStatusEffectName()
	return "particles/status_fx/status_effect_ghost.vpcf"
end
function modifier_imba_decrepify:StatusEffectPriority()
...
function modifier_imba_decrepify:OnDestroy()
	if IsServer() then
		...
		-- Elfansoer: fix dealing so little damage
		-- damage = damage * 0.01
...
LinkLuaModifier("modifier_imba_nether_ward_aura", "abilities/dota_imba/hero_pugna.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_nether_ward_degen", "abilities/dota_imba/hero_pugna.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_life_drain", "abilities/dota_imba/hero_pugna.lua", LUA_MODIFIER_MOTION_NONE)
