...
LinkLuaModifier("modifier_imba_overload", 			"abilities/dota_imba/hero_storm_spirit.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_overload_buff", 		"abilities/dota_imba/hero_storm_spirit.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_overload_debuff", 	"abilities/dota_imba/hero_storm_spirit.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_ball_lightning", "abilities/dota_imba/hero_storm_spirit.lua", LUA_MODIFIER_MOTION_NONE)
