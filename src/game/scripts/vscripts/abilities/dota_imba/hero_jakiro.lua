...
LinkLuaModifier("modifier_imba_fire_breath_debuff", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_fire_breath_caster", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_ice_breath_debuff", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_ice_breath_caster", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_ice_path_thinker", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_ice_path_freeze_debuff", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_ice_path_slow_debuff", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_liquid_fire_caster", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_liquid_fire_animate", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_liquid_fire_debuff", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_macropyre_thinker", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_macropyre_debuff", "abilities/dota_imba/hero_jakiro", LUA_MODIFIER_MOTION_NONE)
