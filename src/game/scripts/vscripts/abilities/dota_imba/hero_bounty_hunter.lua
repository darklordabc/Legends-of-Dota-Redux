...
LinkLuaModifier("modifier_imba_shadow_walk_buff_invis", "abilities/dota_imba/hero_bounty_hunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_shadow_walk_vision", "abilities/dota_imba/hero_bounty_hunter", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_headhunter_passive", "abilities/dota_imba/hero_bounty_hunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_headhunter_debuff_handler", "abilities/dota_imba/hero_bounty_hunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_headhunter_buff_handler", "abilities/dota_imba/hero_bounty_hunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_headhunter_debuff_illu", "abilities/dota_imba/hero_bounty_hunter", LUA_MODIFIER_MOTION_NONE)
...
for LinkedModifier, MotionController in pairs(LinkedModifiers) do
	LinkLuaModifier(LinkedModifier, "abilities/dota_imba/hero_bounty_hunter", MotionController)
end
