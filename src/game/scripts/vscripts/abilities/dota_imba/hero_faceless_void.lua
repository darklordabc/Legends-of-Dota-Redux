...
LinkLuaModifier("modifier_imba_faceless_void_timelord", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)	-- increases attack speed by [current attack speed] * 0.15
...
LinkLuaModifier("modifier_imba_faceless_void_time_walk_damage_counter", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)-- Reduced moenemt/attack speed stolen by caster
LinkLuaModifier("modifier_imba_faceless_void_time_walk_buff_as", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)		-- Bonus attack speed stolen from enemies
LinkLuaModifier("modifier_imba_faceless_void_time_walk_buff_ms", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)		-- Bonus movement speed stolen from enemies
LinkLuaModifier("modifier_imba_faceless_void_time_walk_cast", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)	-- Motion + invuln
LinkLuaModifier("modifier_imba_faceless_void_time_walk_slow", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)			-- Reduced moenemt/attack speed stolen by caster
...
LinkLuaModifier("modifier_imba_faceless_void_time_dilation_buff", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)			-- Ally/Caster buff
LinkLuaModifier("modifier_imba_faceless_void_time_dilation_slow", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)			-- Enemy debuff
LinkLuaModifier("modifier_imba_time_dilation_talent", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)	-- Talent caster buff
...
LinkLuaModifier("modifier_imba_faceless_void_time_lock", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)		-- Passive effect
LinkLuaModifier("modifier_imba_faceless_void_time_lock_stun", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)	-- The stun
...
LinkLuaModifier("modifier_imba_faceless_void_chronosphere_aura", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)		-- Aura - Handle applier
LinkLuaModifier("modifier_imba_faceless_void_chronosphere_handler", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)	-- Handler
LinkLuaModifier("modifier_imba_faceless_void_chronosphere_caster_buff", "abilities/dota_imba/hero_faceless_void.lua", LUA_MODIFIER_MOTION_NONE)-- Bonus attack speed for caster and their minions
