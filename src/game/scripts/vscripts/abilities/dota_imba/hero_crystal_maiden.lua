...
LinkLuaModifier("modifier_imba_arcane_dynamo", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_maiden_ability_slow", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_crystal_nova_slow", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_nova_snowfield_ally_aura", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
...
-- 		   Frost Bite          --
---------------------------------
LinkLuaModifier("modifier_imba_crystal_maiden_frostbite_passive_ready", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_maiden_frostbite_passive_recharging", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_maiden_frostbite_enemy", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_maiden_frostbite_enemy_talent", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_maiden_frostbite_ally", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_crystal_maiden_brilliance_aura_emitter", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_maiden_brilliance_aura", "abilities/dota_imba/hero_crystal_maiden.lua", LUA_MODIFIER_MOTION_NONE)
