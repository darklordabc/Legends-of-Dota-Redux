...
LinkLuaModifier("modifier_imba_eleven_curses", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_royal_wrath", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_hurl_through_hell", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_hurl_through_hell_slow", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_hurl_through_hell_root", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_hurl_through_hell_disarm", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_hurl_through_hell_silence", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_hurl_through_hell_mute", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_hurl_through_hell_break", "abilities/dota_imba/hero_hell_empress.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_hell_empress_ambient_effects", "abilities/dota_imba/hero_hell_empress", LUA_MODIFIER_MOTION_NONE)
