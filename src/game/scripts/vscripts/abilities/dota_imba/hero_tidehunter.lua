...
LinkLuaModifier("modifier_imba_tidehunter_kraken_shell", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_tidehunter_kraken_shell_backstroke", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_tidehunter_kraken_shell_greater_hardening", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_tidehunter_anchor_smash", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_tidehunter_anchor_smash_suppression", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_tidehunter_anchor_smash_handler", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_tidehunter_anchor_smash_throw", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_tidehunter_ravage_handler", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_tidehunter_ravage_creeping_wave", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_tidehunter_kraken_shell_backstroke:DeclareFunctions()
	local decFuncs = 
	{
		-- elfansoer: fix backstroke causing animation to stuck in a certain position
...
LinkLuaModifier("modifier_special_bonus_imba_tidehunter_greater_hardening", "abilities/dota_imba/hero_tidehunter", LUA_MODIFIER_MOTION_NONE)
