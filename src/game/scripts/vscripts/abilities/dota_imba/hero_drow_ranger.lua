...
LinkLuaModifier("modifier_imba_frost_arrows_thinker", "abilities/dota_imba/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_gust_silence", "abilities/dota_imba/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_trueshot_aura", "abilities/dota_imba/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_trueshot", "abilities/dota_imba/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_marksmanship", "abilities/dota_imba/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_marksmanship_scepter_dmg_reduction", "abilities/dota_imba/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_markmanship_aura", "abilities/dota_imba/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_markmanship_buff", "abilities/dota_imba/hero_drow_ranger", LUA_MODIFIER_MOTION_NONE)
