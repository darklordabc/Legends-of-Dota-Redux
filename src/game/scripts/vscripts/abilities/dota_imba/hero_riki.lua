...
LinkLuaModifier( "modifier_imba_riki_cloak_and_dagger", "abilities/dota_imba/hero_riki.lua", LUA_MODIFIER_MOTION_NONE )	-- Backstab and invisibility handler
LinkLuaModifier( "modifier_imba_riki_invisibility", "abilities/dota_imba/hero_riki.lua", LUA_MODIFIER_MOTION_NONE )		-- Invisibility modifier
LinkLuaModifier( "modifier_imba_riki_backstab_translation", "abilities/dota_imba/hero_riki.lua", LUA_MODIFIER_MOTION_NONE )		-- Attack translate
LinkLuaModifier( "modifier_imba_riki_peek_a_boo", "abilities/dota_imba/hero_riki.lua", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_imba_riki_tricks_of_the_trade_primary", "abilities/dota_imba/hero_riki.lua", LUA_MODIFIER_MOTION_NONE )		-- Hides the caster and damages all enemies in the AoE
LinkLuaModifier( "modifier_imba_riki_tricks_of_the_trade_secondary", "abilities/dota_imba/hero_riki.lua", LUA_MODIFIER_MOTION_NONE )	-- Attacks a single enemy based on attack speed
LinkLuaModifier( "modifier_imba_martyrs_mark", "abilities/dota_imba/hero_riki.lua", LUA_MODIFIER_MOTION_NONE )
...
for LinkedModifier, MotionController in pairs(LinkedModifiers) do
	LinkLuaModifier(LinkedModifier, "abilities/dota_imba/hero_riki", MotionController)
end
-------------------------------------------
