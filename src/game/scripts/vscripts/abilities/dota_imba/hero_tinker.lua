...
--			   REARM
-------------------------------------------
LinkLuaModifier("modifier_imba_rearm_animation", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_rearm_overdrive", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_rearm_shield", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
...
--			   LASER
-------------------------------------------
LinkLuaModifier("modifier_imba_laser_blind", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
...
-------------------------------------------
LinkLuaModifier("modifier_imba_heat_seeking_missile_break", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
...
-------------------------------------------
LinkLuaModifier("modifier_imba_march_flame_aura", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_march_flame_damage", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_march_tesla_stun", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_march_sticky_root", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_march_dismantle", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_march_drone", "abilities/dota_imba/hero_tinker", LUA_MODIFIER_MOTION_NONE)
