...
for LinkedModifier, MotionController in pairs(LinkedModifiers) do
	LinkLuaModifier(LinkedModifier, "abilities/dota_imba/hero_disruptor", MotionController)
end
...
LinkLuaModifier("modifier_special_bonus_imba_disruptor_9", "abilities/dota_imba/hero_disruptor", LUA_MODIFIER_MOTION_NONE)
