...
LinkLuaModifier("modifier_imba_dark_seer_vacuum", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_imba_dark_seer_vacuum_wormhole", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_dark_seer_vacuum_refresh_tracker", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_dark_seer_wormhole", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_HORIZONTAL)

LinkLuaModifier("modifier_imba_dark_seer_ion_shell", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_HORIZONTAL)

LinkLuaModifier("modifier_imba_dark_seer_surge", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_dark_seer_wall_of_replica", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_dark_seer_wall_of_replica_slow", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_NONE)
...
function imba_dark_seer_vacuum:OnSpellStart()
	...
	-- Elfansoer: Wormhole should be given automatically
	if not wormhole_ability then
		wormhole_ability = self:GetCaster():AddAbility( "imba_dark_seer_wormhole" )
	end
...
LinkLuaModifier("modifier_imba_dark_seer_ion_shell_handler", "abilities/dota_imba/hero_dark_seer", LUA_MODIFIER_MOTION_NONE)
