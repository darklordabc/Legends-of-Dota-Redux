...
LinkLuaModifier("modifier_imba_spirit_breaker_charge_of_darkness_clothesline", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_imba_spirit_breaker_charge_of_darkness_taxi", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_imba_spirit_breaker_charge_of_darkness_taxi_counter", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_spirit_breaker_charge_of_darkness_taxi_tracker", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_spirit_breaker_bulldoze", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_spirit_breaker_bulldoze_empowering_haste_aura", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_spirit_breaker_bulldoze_empowering_haste", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_spirit_breaker_greater_bash", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_spirit_breaker_greater_bash_speed", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_spirit_breaker_nether_strike", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_spirit_breaker_nether_strike_vision", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_spirit_breaker_nether_strike_planeswalker", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_spirit_breaker_nether_strike_planeswalker_enemy", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_spirit_breaker_charge_of_darkness:UpdateHorizontalMotion( me, dt )
	...
	-- elfansoer: fix Clothesline dragging along basic units
	...
	local enemies = FindUnitsInRadius(self:GetCaster():GetTeamNumber(), self:GetParent():GetAbsOrigin() + (self:GetParent():GetForwardVector() * 20), nil, self.bash_radius, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO, DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES, FIND_CLOSEST, false)
...
function modifier_imba_spirit_breaker_nether_strike_planeswalker_enemy:OnCreated()
	...
	local enemy_planeswalker_particle = ParticleManager:CreateParticle("particles/econ/items/spirit_breaker/spirit_breaker_iron_surge/spirit_breaker_charge_target_iron.vpcf", PATTACH_OVERHEAD_FOLLOW, self:GetParent())
...
LinkLuaModifier("modifier_special_bonus_imba_spirit_breaker_charge_speed", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_spirit_breaker_bulldoze_cooldown", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_spirit_breaker_bonus_health", "abilities/dota_imba/hero_spirit_breaker", LUA_MODIFIER_MOTION_NONE)
