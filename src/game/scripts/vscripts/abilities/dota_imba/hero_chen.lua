...
LinkLuaModifier("modifier_imba_chen_divine_favor", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chen_divine_favor_aura", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chen_divine_favor_aura_buff", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_chen_holy_persuasion", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chen_holy_persuasion_tracker", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chen_holy_persuasion_counter", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chen_holy_persuasion_teleport", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chen_holy_persuasion_immortalized", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chen_holy_persuasion_immortalized_tracker", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chen_holy_persuasion_immortalized_counter", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_chen_hand_of_god_overheal", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_special_bonus_imba_chen_divine_favor_cd_reduction", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_chen_test_of_faith_cd_reduction", "abilities/dota_imba/hero_chen", LUA_MODIFIER_MOTION_NONE)
