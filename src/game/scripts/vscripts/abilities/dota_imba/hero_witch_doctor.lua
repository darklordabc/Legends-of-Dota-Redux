...
LinkLuaModifier("modifier_imba_voodoo_restoration", "abilities/dota_imba/hero_witch_doctor", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_voodoo_restoration_heal", "abilities/dota_imba/hero_witch_doctor", LUA_MODIFIER_MOTION_NONE)
...
--				MALEDICT
-------------------------------------------
LinkLuaModifier("modifier_imba_maledict", "abilities/dota_imba/hero_witch_doctor", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_maledict_talent", "abilities/dota_imba/hero_witch_doctor", LUA_MODIFIER_MOTION_NONE)
...
--				DEATH WARD
-------------------------------------------
LinkLuaModifier("modifier_imba_death_ward", "abilities/dota_imba/hero_witch_doctor", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_ward_caster", "abilities/dota_imba/hero_witch_doctor", LUA_MODIFIER_MOTION_NONE)
