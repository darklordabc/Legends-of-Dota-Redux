...
LinkLuaModifier("modifier_imba_earthshock_slow", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_trembling_steps_buff", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_trembling_steps_prevent", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_trembling_steps_debuff", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_overpower_buff", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_overpower_disarm", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_overpower_talent_fangs", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_fury_swipes", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_fury_swipes_debuff", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_fury_swipes_talent_ripper", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_enrage_buff", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_enrage_talent_buff", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_talent_enrage_damage", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_talent_enrage_prevent", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_terrorital_hunter_aura", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_terrorital_hunter_fogvision", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_terrorital_hunter_talent_tenacity", "abilities/dota_imba/hero_ursa", LUA_MODIFIER_MOTION_NONE)
