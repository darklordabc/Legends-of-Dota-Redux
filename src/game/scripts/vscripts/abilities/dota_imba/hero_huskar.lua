...
LinkLuaModifier("modifier_imba_huskar_inner_fire_disarm", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_huskar_inner_fire_raze_land", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_huskar_inner_fire_raze_land_aura", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_generic_orb_effect_lua", "abilities/dota_imba/modifier_generic_orb_effect_lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_huskar_burning_spear_counter", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_huskar_burning_spear_debuff", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_huskar_berserkers_blood", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_huskar_berserkers_blood_crimson_priest", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_huskar_inner_vitality", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_huskar_life_break", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_imba_huskar_life_break_charge", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_huskar_life_break_slow", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_huskar_life_break_sac_dagger", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_huskar_life_break_sac_dagger_tracker", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_huskar_life_break_handler", "abilities/dota_imba/hero_huskar", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_huskar_life_break_charge:OnCreated()
	if IsServer() then
		-- Elfansoer: Fix missing reference to imba battlepass
