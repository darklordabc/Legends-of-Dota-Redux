...
LinkLuaModifier("modifier_imba_wisp_tether", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_tether_ally", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_tether_latch", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_tether_slow", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_tether_slow_immune", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_tether_ally_attack", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_tether_bonus_regen", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_wisp_tether:OnCreated(params)
	if IsServer() then 
		...
		-- elfansoer: fix tether causing lag to apply movespeed modifier
		-- self:StartIntervalThink(FrameTime())

		self:SetStackCount( self.target:entindex() )
	else
...
function modifier_imba_wisp_tether:OnIntervalThink()
	-- elfansoer: fix tether causing lag to apply movespeed modifier
	if self.target then
		self.movespeed = self.target:GetIdealSpeed()
	else
		self.movespeed = 0
	end
...
-- elfansoer: fix tether not giving hasted movement
function modifier_imba_wisp_tether_ally:CheckState()
	local state = {
...
function modifier_imba_wisp_tether_ally:OnIntervalThink()
	if IsServer() then
		...
		local projectile = 
		{
			...
			EffectName			= "particles/econ/items/razor/razor_ti6/razor_base_attack_ti6.vpcf",
...
LinkLuaModifier("modifier_imba_wisp_spirits", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_spirit_handler", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_spirits_hero_hit", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_spirits_creep_hit", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_spirits_slow", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_spirit_damage_handler", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_spirits_true_sight", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_wisp_spirits:OnIntervalThink()
	if IsServer() then
		...
		if ability.spirits_num_spirits < idealNumSpiritsSpawned then
			...
			local pfx
			if caster:HasModifier("modifier_imba_wisp_swap_spirits_disarm") then
				local pfx = ParticleManager:CreateParticle("particles/econ/items/wisp/wisp_guardian_ti7.vpcf", PATTACH_ABSORIGIN_FOLLOW, newSpirit)
				newSpirit.spirit_pfx_disarm = pfx
			elseif caster:HasModifier("modifier_imba_wisp_swap_spirits_silence") then
...
function modifier_imba_wisp_spirits:Explode(caster, spirit, explosion_radius, explosion_damage, ability)
	if IsServer() then
		...
		-- elfansoer: fix missing particles
...
function modifier_imba_wisp_spirits_hero_hit:OnCreated(params) 
	if IsServer() then
		...
		slow_modifier:SetStackCount(-100)
	end
end
...
------------------------------------------
LinkLuaModifier("modifier_imba_wisp_swap_spirits_disarm", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_swap_spirits_silence", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_wisp_overcharge", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_overcharge_drain", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_overcharge_regen_talent", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_overcharge_aura", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_wisp_relocate", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_relocate_cast_delay", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_relocate_talent", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_wisp_relocate:OnCreated(params)
	if IsServer() then
		...
		-- elfansoer: fix particles missing
...
LinkLuaModifier("modifier_imba_wisp_overcharge_721", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wisp_overcharge_721_aura", "abilities/dota_imba/hero_wisp.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_wisp_overcharge_721:OnCreated()
	...
	-- elfansoer: fix overcharge missing particle
	local pfx = ParticleManager:CreateParticle( "particles/units/heroes/hero_wisp/wisp_overcharge.vpcf", PATTACH_POINT_FOLLOW, self:GetParent())
...
LinkLuaModifier("modifier_special_bonus_imba_wisp_4", "abilities/dota_imba/hero_wisp", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_wisp_9", "abilities/dota_imba/hero_wisp", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_wisp_10", "abilities/dota_imba/hero_wisp", LUA_MODIFIER_MOTION_NONE)
