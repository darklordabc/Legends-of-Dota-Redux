...
LinkLuaModifier("modifier_imba_arcane_orb_thinker", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_arcane_orb_buff", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_arcane_orb_debuff", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_arcane_orb_instance", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_arcane_orb_thinker:DeclareFunctions()
	local decFunc = {MODIFIER_EVENT_ON_ATTACK_START,
					...
					-- elfansoer: fix arcane orb mismatched projectiles
...
-- elfansoer: fix arcane orb mismatched projectiles
function modifier_imba_arcane_orb_thinker:GetModifierProjectileName()
	if not IsServer() then return end
	if self.arcane_orb_attack then
...
LinkLuaModifier("modifier_imba_astral_imprisonment", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_astral_imprisonment_buff", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_astral_imprisonment_sucked", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_essence_aura", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_essence_aura_buff", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_essence_aura_proc", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_essence_aura_over_maximum", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_essence_aura_over_maximum_indicator", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
	...
	for _,enemy in pairs(enemies) do
		...
		if caster:HasTalent("special_bonus_imba_obsidian_destroyer_7") or not enemy:IsMagicImmune() then            
			...
			if enemy:IsIllusion() then
				...
				-- Elfansoer: fix prison particle not disappearing if prison isn't leveled yet
				-- if scepter and prison_ability and not enemy:HasModifier(modifier_prison) then
				if scepter and prison_ability and prison_ability:GetLevel()>=1 and not enemy:HasModifier(modifier_prison) then
...
LinkLuaModifier("modifier_imba_obsidian_destroyer_equilibrium", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_obsidian_destroyer_equilibrium_active", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_obsidian_destroyer_equilibrium_debuff", "abilities/dota_imba/hero_obsidian_destroyer.lua", LUA_MODIFIER_MOTION_NONE)
