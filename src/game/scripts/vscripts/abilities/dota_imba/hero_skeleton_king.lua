...
LinkLuaModifier("modifier_imba_wraithfire_blast_stun", "abilities/dota_imba/hero_skeleton_king.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_wraithfire_blast_debuff", "abilities/dota_imba/hero_skeleton_king.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_vampiric_aura", "abilities/dota_imba/hero_skeleton_king.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_reincarnation", "abilities/dota_imba/hero_skeleton_king.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_reincarnation_wraith_form_buff", "abilities/dota_imba/hero_skeleton_king.lua", LUA_MODIFIER_MOTION_NONE)
