...
--			  Icarus Dive
-------------------------------------------
LinkLuaModifier("modifier_imba_phoenix_icarus_dive_dash_dummy", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_icarus_dive_extend_burn", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_icarus_dive_ignore_turn_ray", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_icarus_dive_slow_debuff", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
...
--			  Fire Spirits
-------------------------------------------
LinkLuaModifier("modifier_imba_phoenix_fire_spirits_count", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_phoenix_fire_spirits_debuff", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_fire_spirits_buff", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_phoenix_sun_ray_caster_dummy", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_sun_ray_dummy_unit_thinker", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_sun_ray_dummy_buff", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_sun_ray_buff", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_sun_ray_debuff", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_phoenix_supernova_egg_thinker", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_supernova_caster_dummy", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_supernova_bird_thinker", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_supernova_dmg", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_supernova_scepter_passive", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_supernova_scepter_passive_cooldown", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_supernova_egg_double", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_phoenix_burning_wings_buff", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_phoenix_burning_wings_ally_buff", "abilities/dota_imba/hero_phoenix", LUA_MODIFIER_MOTION_NONE)
