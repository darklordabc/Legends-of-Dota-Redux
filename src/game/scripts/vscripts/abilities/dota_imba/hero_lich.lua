...
LinkLuaModifier("modifier_imba_cold_front_passive", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_cold_front_debuff", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_cold_front_freeze", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_frost_nova_debuff", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_special_bonus_imba_lich_11", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_frost_armor_buff", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_frost_armor_debuff", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_frost_armor_freeze", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_frost_armor_auto_cast", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_frost_armor_freezing_point", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_special_bonus_imba_lich_5", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_dark_ritual_creeps", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_dark_ritual_allied_sacrifice", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_dark_ritual_enemy_sacrifice", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_chain_frost_slow", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_chain_frost_talent_buff", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_lich_frost_shield", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_lich_frost_shield_slow", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_special_bonus_imba_lich_9", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_lich_sinister_gaze", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_lich_sinister_gaze_bonus_health", "abilities/dota_imba/hero_lich", LUA_MODIFIER_MOTION_NONE)
