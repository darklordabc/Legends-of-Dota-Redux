...
--------------------------------------------------------------------------------------------------------
if npc_dota_hero_windrunner_perk == nil then npc_dota_hero_windrunner_perk = class({}) end
--------------------------------------------------------------------------------------------------------
--		Modifier: modifier_npc_dota_hero_windrunner_perk				
--------------------------------------------------------------------------------------------------------
if modifier_npc_dota_hero_windrunner_perk == nil then modifier_npc_dota_hero_windrunner_perk = class({}) end
--------------------------------------------------------------------------------------------------------
...
function modifier_npc_dota_hero_windrunner_perk:OnCreated(keys)
	if IsServer() then
		...
		for i = 0, 15 do 
			...
			if ability and ability:IsPassive() and ability:GetName() ~= "attribute_bonus" and ability:GetName() ~= "npc_dota_hero_windrunner_perk" then
				print("Passive spotted, bonus is nullified. " .. ability:GetName())
