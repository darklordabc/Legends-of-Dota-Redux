LinkLuaModifier("modifier_slardar_bash_redux","abilities/void_time_lock.lua",LuaModifierType.LUA_MODIFIER_MOTION_NONE);

class void_time_lock_redux extends CDOTA_Ability_Lua {
