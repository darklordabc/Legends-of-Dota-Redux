...
modifier_special_unique_willpower_40_redux = {}
...
function modifier_special_unique_willpower_40_redux.new(construct, ...)
    local instance = setmetatable({}, modifier_special_unique_willpower_40_redux)
    if construct and modifier_special_unique_willpower_40_redux.constructor then modifier_special_unique_willpower_40_redux.constructor(instance, ...) end
    return instance
end
