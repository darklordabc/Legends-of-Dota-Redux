...
modifier_special_unique_willpower_24_redux = {}
...
function modifier_special_unique_willpower_24_redux.new(construct, ...)
    local instance = setmetatable({}, modifier_special_unique_willpower_24_redux)
    if construct and modifier_special_unique_willpower_24_redux.constructor then modifier_special_unique_willpower_24_redux.constructor(instance, ...) end
    return instance
end
