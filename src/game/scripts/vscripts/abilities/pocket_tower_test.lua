...
function item_redux_pocket_tower.new(construct, ...)
    local instance = setmetatable({}, item_redux_pocket_tower)
    if construct and item_redux_pocket_tower.constructor then item_redux_pocket_tower.constructor(instance, ...) end
    return instance
end
