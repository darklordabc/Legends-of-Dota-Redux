LinkLuaModifier( "modifier_jingtong", "abilities/jingtong_op.lua" ,LUA_MODIFIER_MOTION_NONE )

if jingtong_op ~= "" then jingtong_op = class({}) end

function jingtong_op:GetIntrinsicModifierName()
