if tiny_grow_lod_redux == nil then tiny_grow_lod_redux = class({}) end 
...
function tiny_grow_lod_redux:GetIntrinsicModifierName()
    return "modifier_tiny_grow_lod"
end

function tiny_grow_lod_redux:GetBehavior ()
    local behav = DOTA_ABILITY_BEHAVIOR_PASSIVE
    return behav
end

function tiny_grow_lod_redux:OnUpgrade()
    if IsServer() then
