...
function dark_blade:OnSpellStart()
	...
	if hTarget ~= nil then
		...
		local nFXIndex = ParticleManager:CreateParticle( "particles/econ/items/terrorblade/terrorblade_back_ti8/terrorblade_sunder_ti8.vpcf", PATTACH_CUSTOMORIGIN, nil );
