...
LinkLuaModifier("modifier_imba_strafe_aspd", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_strafe_mount", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)

function imba_clinkz_strafe:GetAbilityTextureName()
   return "custom/imba_clinkz_strafe"
end
...
imba_clinkz_strafe_op = class({})

function imba_clinkz_strafe_op:GetAbilityTextureName()
   return "custom/imba_clinkz_strafe"
end

function imba_clinkz_strafe_op:IsHiddenWhenStolen() return false end
function imba_clinkz_strafe_op:IsNetherWardStealable() return false end
function imba_clinkz_strafe_op:GetCooldown(level)
    if IsServer() then
        local caster = self:GetCaster()
        local duration = self:GetSpecialValueFor("duration")        
        local modifier_mount = "modifier_imba_strafe_mount"
...
function imba_clinkz_strafe_op:GetBehavior()
    local caster = self:GetCaster()
    local modifier_mount = "modifier_imba_strafe_mount"
...
function imba_clinkz_strafe_op:GetManaCost(level)
    local caster = self:GetCaster()
    -- If Clinkz is currently mounted, remove the mana cost
    if caster:HasModifier("modifier_imba_strafe_mount") then
        return 0    
...
function imba_clinkz_strafe_op:OnSpellStart()
    if IsServer() then        
            -- Ability properties
            local caster = self:GetCaster()
            local ability = self
...
LinkLuaModifier("modifier_imba_searing_arrows_passive", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_searing_arrows_active", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_skeleton_walk_invis", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skeleton_walk_spook", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skeleton_walk_talent_ms", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_death_pact_buff", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_stack_creep", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_stack_hero", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_talent_debuff", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_death_pact_talent_buff", "abilities/dota imba/hero_clinkz", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_death_pact_stack_creep:OnCreated()
    ...
    self.creep_bonus_hp_pct = self.creep_bonus_hp_pct * (1) * 0.01
    self.creep_bonus_dmg_pct = self.creep_bonus_dmg_pct * (1) * 0.01
...
function modifier_imba_death_pact_stack_hero:OnCreated()
    ...
    -- #7 Talent: Death Pact bonuses increase
    self.hero_bonus_hp_dmg_mult = self.hero_bonus_hp_dmg_mult * (1) * 0.01
    self.hero_bonus_dmg_pct = self.hero_bonus_dmg_pct * (1) * 0.01
