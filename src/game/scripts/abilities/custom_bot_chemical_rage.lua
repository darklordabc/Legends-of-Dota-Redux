...
function ChemicalRageActivate( event )
	...
	-- Cast the spell
	if caster:GetHealthPercent() < 90 and ability:GetCooldownTimeRemaining() == 0 and caster:GetMana() >= ability:GetManaCost(ability:GetLevel() - 1) and not caster:IsChanneling() then
