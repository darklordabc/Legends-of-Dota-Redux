...
{
	var victory_condition = CustomNetTables.GetTableValue( "phase_ingame", "victory_condition" );
...
(function()
{
	...
	UpdateKillsToWin();
	CustomNetTables.SubscribeNetTableListener( "phase_ingame", OnGameStateChanged );
