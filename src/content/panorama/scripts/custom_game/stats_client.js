...
var ServerAddress = ServerDebug ? "http://127.0.0.1:8080/" : "http://3.23.86.18:8080/";
...
function LoadFavBuilds(rootPanel) {
	if (!Game.GetLocalPlayerInfo()) {
		...
		GetDataFromServer("getFavoriteSkillBuilds", { steamID: Game.GetLocalPlayerInfo().player_steamid }, function (
			favoriteBuilds,
		) {
			var con = rootPanel;
