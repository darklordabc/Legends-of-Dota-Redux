...
function Pregame:processOptions()
    ...
    statCollection:setFlags({
        ...
        ['Block Troll Combos'] = self.optionStore['lodOptionBanningBlockTrollCombos'] == 1,                     -- Block Troll Combos              [boolean, true/false]
        ['Use LoD BanList'] = self.optionStore['lodOptionBanningUseBanList'] == 1,                              -- Use LoD BanList                 [boolean, true/false]
        ['Block OP Abilities'] = self.optionStore['lodOptionAdvancedOPAbilities'] == 1,                         -- Block OP Abilities              [boolean, true/false]
        ['Block Invis Abilities'] = self.optionStore['lodOptionBanningBanInvis'] == 1,                          -- Block Invis Abilities           [boolean, true/false]
        ...
        ['Towers Per Lane'] = self.optionStore['lodOptionGameSpeedTowersPerLane'],                              -- Towers Per Lane                 [boolean, true/false]
        ['Start With Upgraded Ults'] = self.optionStore['lodOptionGameSpeedUpgradedUlts'] == 1,                 -- Start with upgraded ults        [boolean, true/false]
        ['Enable Easy Mode'] = self.optionStore['lodOptionCrazyEasymode'] == 1,                                 -- Enabled Easy Mode               [boolean, true/false]
        ['Allow Hero Abilities'] = self.optionStore['lodOptionAdvancedHeroAbilities'] == 1,                     -- Allow Hero Abilities            [boolean, true/false]
        ['Allow Neutral Abilities'] = self.optionStore['lodOptionAdvancedNeutralAbilities'] == 1,               -- Allow Neutral Abilities         [boolean, true/false]
        ['Allow Wraith Night Skills'] = self.optionStore['lodOptionAdvancedNeutralWraithNight'] == 1,           -- Allow Wraith Night Abilities    [boolean, true/false]
        ['Hide Enemy Picks'] = self.optionStore['lodOptionAdvancedHidePicks'] == 1,                             -- Hide Enemy Picks                [boolean, true/false]
        ['Unique Skills'] = self.optionStore['lodOptionAdvancedUniqueSkills'],                                  -- Unique Skills                   [number, 0 - 2]
        ['Unique Heroes'] = self.optionStore['lodOptionAdvancedUniqueHeroes'] == 1,                             -- Unique Heroes                   [boolean, true/false]
        ['Allow Selecting Primary Attribute'] = self.optionStore['lodOptionAdvancedSelectPrimaryAttr'] == 1,    -- Allow Select Primary Attribute  [boolean, true/false]
        ['Stop Fountain Camping'] = self.optionStore['lodOptionCrazyNoCamping'] == 1,                           -- Stop Fountain Camping           [boolean, true/false]
        ['Enable Universal Shop'] = self.optionStore['lodOptionCrazyUniversalShop'] == 1,                       -- Universal Shop                  [boolean, true/false]
        ['Enable All Vision'] = self.optionStore['lodOptionCrazyAllVision'] == 1,                               -- Enabled All Vision              [boolean, true/false]
        ['Enable Multicast Madness'] = self.optionStore['lodOptionCrazyMulticast'] == 1,                        -- Enable Multicast Madness        [boolean, true/false]
        ['Enable WTF Mode'] = self.optionStore['lodOptionCrazyWTF'] == 1,                                       -- Enable WTF Mode                 [boolean, true/false]
    })
end
